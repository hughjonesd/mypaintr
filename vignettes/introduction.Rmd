...
mypaint brushes can only be used with the `mypaint_device()` graphics device. 
...
You can also use the special geoms `geom_mypaint_bar()` and `geom_mypaint_col()`. These allow you to use special fill
patterns, like `zigzag()` and `jumble()`.
